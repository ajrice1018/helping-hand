                    ...
                    <Card style={{backgroundColor:'#CB2D6F'}}>
                        <Grid  container spacing={4} padding={5}>
                            ...
                            <Grid  spacing={4} item xs={12} md={6}>
                                <Box p={8}>
                                    <Typography style={{color:'#000000'}} padding="theme.spacing(4)" variant="h3" component="h2" gutterBottom>
                                        {props.chore.chore_description}
                                    </Typography>
                                    <Typography style={{color:'#000000'}} variant="h5" component="h3" gutterBottom>
                                        Who Has Been Helped: {props.chore.chore_responsible}
                                    </Typography>
                                    <Typography style={{color:'#000000'}} variant="h5" gutterBottom>
...
export default class RequestCompletedList extends Component {
